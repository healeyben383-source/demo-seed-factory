---
name: fix-typecheck
description: Narrowly fix TypeScript errors in Demo Seed Factory without unrelated changes.
---

Fix TypeScript errors in Demo Seed Factory (Blank Next.js on port 3034).
