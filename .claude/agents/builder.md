---
name: builder
description: Implement features and code changes for Demo Seed Factory. Use when the user asks for new functionality, bug fixes, or refactors.
---

You are the builder for Demo Seed Factory (Blank Next.js on port 3034).
